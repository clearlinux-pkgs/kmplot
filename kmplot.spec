...
Source0  : https://download.kde.org/stable/release-service/19.12.3/src/kmplot-19.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.3/src/kmplot-19.12.3.tar.xz.sig
...
%prep
%setup -q -n kmplot-19.12.3
cd %{_builddir}/kmplot-19.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583451210
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kmplot-19.12.3/COPYING %{buildroot}/usr/share/package-licenses/kmplot/133efad5329acf364135c569ac01ec084c3d4647
cp %{_builddir}/kmplot-19.12.3/COPYING.DOC %{buildroot}/usr/share/package-licenses/kmplot/1bd373e4851a93027ba70064bd7dbdc6827147e1
pushd clr-build
%make_install
popd
%find_lang kmplot
