...
Source0  : https://download.kde.org/stable/release-service/21.08.2/src/kmplot-21.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.08.2/src/kmplot-21.08.2.tar.xz.sig
...
%prep
%setup -q -n kmplot-21.08.2
cd %{_builddir}/kmplot-21.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1634351539
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kmplot-21.08.2/LICENSES/GFDL-1.2-or-later.txt %{buildroot}/usr/share/package-licenses/kmplot/ee03d68f6be20b170e5ea5d114d6acafb3f2d1dc
cp %{_builddir}/kmplot-21.08.2/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kmplot/3e8971c6c5f16674958913a94a36b1ea7a00ac46
pushd clr-build
%make_install
popd
%find_lang kmplot
