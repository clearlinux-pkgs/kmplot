...
Version  : 19.04.0
Release  : 5
URL      : https://download.kde.org/stable/applications/19.04.0/src/kmplot-19.04.0.tar.xz
Source0  : https://download.kde.org/stable/applications/19.04.0/src/kmplot-19.04.0.tar.xz
Source99 : https://download.kde.org/stable/applications/19.04.0/src/kmplot-19.04.0.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1555616602
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
cp COPYING.DOC %{buildroot}/usr/share/package-licenses/kmplot/COPYING.DOC
pushd clr-build
%make_install
popd
%find_lang kmplot
...
%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/kmplot/COPYING
/usr/share/package-licenses/kmplot/COPYING.DOC
