...
Source0  : https://download.kde.org/stable/release-service/19.12.2/src/kmplot-19.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.2/src/kmplot-19.12.2.tar.xz.sig
...
%prep
%setup -q -n kmplot-19.12.2
cd %{_builddir}/kmplot-19.12.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581027045
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kmplot-19.12.2/COPYING %{buildroot}/usr/share/package-licenses/kmplot/133efad5329acf364135c569ac01ec084c3d4647
cp %{_builddir}/kmplot-19.12.2/COPYING.DOC %{buildroot}/usr/share/package-licenses/kmplot/1bd373e4851a93027ba70064bd7dbdc6827147e1
pushd clr-build
%make_install
popd
%find_lang kmplot
