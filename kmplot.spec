...
Version  : 18.08.0
Release  : 1
URL      : https://download.kde.org/stable/applications/18.08.0/src/kmplot-18.08.0.tar.xz
Source0  : https://download.kde.org/stable/applications/18.08.0/src/kmplot-18.08.0.tar.xz
Summary  : No detailed summary available
Group    : Development/Tools
License  : GFDL-1.2 GPL-2.0
Requires: kmplot-bin
Requires: kmplot-lib
Requires: kmplot-data
Requires: kmplot-license
Requires: kmplot-locales
Requires: kmplot-man
...
export LANG=C
export SOURCE_DATE_EPOCH=1535199966
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
export SOURCE_DATE_EPOCH=1535199966
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/kmplot
cp COPYING %{buildroot}/usr/share/doc/kmplot/COPYING
cp COPYING.DOC %{buildroot}/usr/share/doc/kmplot/COPYING.DOC
pushd clr-build
%make_install
popd
%find_lang kmplot
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/kmplot/COPYING
/usr/share/doc/kmplot/COPYING.DOC
